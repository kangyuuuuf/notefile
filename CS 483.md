...
#### For 1D convolution kernels

-   Load (TILE_WIDTH + MASK_WDITH - 1) elements from global memory to shared memory
-   Replace (TILE_WIDTH * MAKK_WIDTH) global memory accesses with shared memory accesses
-   This leads to bandwidth reduction of (TILE_SIZE * MASK_WIDTH)/(TILE_SIZE + MASK_WIDTH - 1)
